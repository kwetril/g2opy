...
/*
 * Class:     com_mapbox_g2o_SparseOptimizer
 * Method:    nativeAddVertexXY
 * Signature: (JJDDZ)V
 */
JNIEXPORT void JNICALL Java_com_mapbox_g2o_SparseOptimizer_nativeAddVertexXY
  (JNIEnv *, jclass, jlong, jlong, jdouble, jdouble, jboolean);

/*
 * Class:     com_mapbox_g2o_SparseOptimizer
 * Method:    nativeAddEdgeSE2SE2
